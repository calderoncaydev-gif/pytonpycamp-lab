    ...
    if user_name and user_surname and user_email and user_gender and user_new_pass and user_con_pass:
        if user_new_pass == user_con_pass:
            if click_check_btn:
                ...
                conn = mysql.connector.connect(host='localhost',username='root',password='',database = 'test-pyton')
...
def login_func(event=None):
    ...
    conn = mysql.connector.connect(host='localhost',username='root',password='',database = 'test-python')
